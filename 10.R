...
result_table <- data.frame(Model = svm_models, Accuracy = svm_accuracies, Recall = svm_recalls)  #甚至完全一样
...
result_table <- data.frame(Model = rf_models, Accuracy = rf_accuracies, Recall = rf_recalls) #甚至不如默认
...
result_table <- data.frame(Model = ada_models, Accuracy = ada_accuracies, Recall = ada_recalls) #甚至不如默认
...
result_table <- data.frame(Model = xgb_models, Accuracy = xgb_accuracies, Recall = xgb_recalls) #甚至不如默认
